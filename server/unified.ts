...
//     image: `https://basedtraders.fun/achievements/${achievementId}.png`, // You'll need to upload these images
//     external_url: 'https://basedtraders.fun',
//     attributes: [
//       {
//         trait_type: 'Rarity',
...
app.get('/api/share-image', async (req, res) => {
  ...
  const imageUrl = `https://basedtraders.fun/api/share-image-png?token=${encodeURIComponent(token)}&leverage=${leverage}&profit=${profit}&profitPercent=${profitPercent}`
